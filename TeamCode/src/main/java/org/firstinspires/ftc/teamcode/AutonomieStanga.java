...
@Autonomous(name="Autonomie Stanga", group="Autonomie")
...
public class AutonomieStanga extends LinearOpMode{
    ...
    private double powerMiscareRoti = 0.35;
    ...
    private void MersSpreZona1() {
        ...
        if(opModeIsActive()){
            ...
            sleep(500);
            MiscareRotiDistanta("Fata", 52);
            sleep(500);
            MiscareRotiDistanta("Stanga", 10);
            sleep(500);
        }
    }
    ...
    private void PuneConuri() {
        ...
        if(opModeIsActive()) {
            MiscareRotiDistanta("Spate",65);
            sleep(200);
            RotatieDistanta("Dreapta", 155);
            MiscareGlisiere("Sus", 0.4);
            sleep(200);
            MiscareRotiDistanta("Fata", 25);
            sleep(500);
            Grab("Deschis");
            sleep(500);
    ...
    private void MersSpreStack() {
        if(opModeIsActive()){
            ...
            MiscareRotiDistanta("Fata", 143);
            sleep(100);
            RotatieDistanta("Dreapta", 67);
            sleep(100);
            MiscareGlisiere("Sus", 0.9);
            sleep(100);
            MiscareRotiDistanta("Fata", 32);
            sleep(300);
            Grab("Deschis");
            sleep(200);
            MiscareRotiDistanta("Spate", 28);
            sleep(200);
            RotatieDistanta("Stanga", 180);
            MiscareGlisiere("Jos", 0.9);
            sleep(100);
            MiscareRotiDistanta("Fata", 65);
            sleep(200);
            Grab("Inchis");
            sleep(600);
    ...
    // Metoda care face robotul sa se roteasca la un anumit grad (se folosesc encodere)
    ...
    // Metoda care face robotul sa se deplaseze pe o anumita distanta
    ...
    // Metoda care actioneaza clestii
